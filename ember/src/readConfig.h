...
public:
    ...
    double integratorMaxTimestep; //!< [cvodeTolerances.maximumTimestep]

    // RK23 integrator parameters
    double rk23RelTol; //!< [rk23Tolerances.relativeTolerance]
    double rk23AbsTol; //!< [rk23Tolerances.absoluteTolerance]
    double rk23MinTimestep; //!< [rk23Tolerances.minimumTimestep]
    double rk23MaxTimestep; //!< [rk23Tolerances.maximumTimestep]
    int rk23IterationCount; //!< [rk23Tolerances.iterationCount]
    int rk23MaxStepsNumber; //!< [rk23Tolerances.maxStepsNumber]

    // CVODE integrator parameters
    double cvode_reltol; //!< [cvodeTolerances.relativeTolerance]
    double cvode_abstol_temperature; //!< [cvodeTolerances.temperatureAbsTol]
    double cvode_abstol_species; //!< [cvodeTolerances.speciesAbsTol]
    double cvode_minStep; //!< [cvodeTolerances.minimumTimestep]
    double cvode_maxStep; //!< [cvodeTolerances.maximumTimestep]

    double rk45AbsTol; //!< [cvodeTolerances.relativeTolerance]
    double rk45RelTol; //!< [cvodeTolerances.temperatureAbsTol]
    double rk45MinStep; //!< [cvodeTolerances.minimumTimestep]
    double rk45MaxStep; //!< [cvodeTolerances.maximumTimestep]
