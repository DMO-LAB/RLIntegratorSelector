...
double CanteraGas::getEquivalenceRatio() const
{
    return thermo->equivalenceRatio();
}

double CanteraGas::getEquivalenceRatio(const std::string& fuel, const std::string& oxidizer) const
{
    return thermo->equivalenceRatio(fuel, oxidizer);
}